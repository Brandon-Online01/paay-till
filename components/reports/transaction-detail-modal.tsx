...
import { X, Calendar, User, CreditCard, Package, MapPin, Truck } from 'lucide-react-native';
        ...
        <ScrollView className="flex-1 p-6">
          ...
          <View className="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <View className="space-y-2">
              ...
              {transaction.receiptOptions?.phoneNumber && (
                <View className="flex-row items-center">
            ...
            {transaction.items.map((item, index) => (
              <View key={index} className="flex-row justify-between items-center py-3 border-b border-gray-200">
                <View className="flex-1">
                  ...
                  <Text className="text-sm text-gray-600 font-primary">
                    Qty: {item.quantity} × R{item.calculatedPrice?.toFixed(2) || item.price.toFixed(2)}
                  </Text>
          ...
          <View className="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <View className="space-y-2">
              <View className="flex-row justify-between">
                <Text className="text-gray-600 font-primary">Subtotal</Text>
              ...
              {transaction.discount > 0 && (
                <View className="flex-row justify-between">
                  <Text className="text-gray-600 font-primary">Discount</Text>
              ...
              <View className="flex-row justify-between">
                <Text className="text-gray-600 font-primary">Tax</Text>
                <Text className="text-gray-900 font-primary">
              ...
              {transaction.change > 0 && (
                <View className="flex-row justify-between">
                  <Text className="text-gray-600 font-primary">Change Given</Text>
                  <Text className="text-gray-900 font-primary">
            ...
            <View className="mb-6">
              ...
              <View className="space-y-1">
                {transaction.receiptOptions.print && (
                  <Text className="text-gray-600 font-primary">✓ Printed receipt</Text>
                )}
                {transaction.receiptOptions.sms && (
                  <Text className="text-gray-600 font-primary">✓ SMS receipt</Text>
                )}
                {transaction.receiptOptions.email && (
                  <Text className="text-gray-600 font-primary">✓ Email receipt</Text>
                )}
              </View>
            </View>
          )}
